...
import { MosqueeInfoForm, mosqueeInfoSchema } from "../components/mosquee-info-form.component";
import { MosqueeOpeningHourForm } from "../components/mosquee-opening-hour-form.component";
...
const fullSchema = mosqueeInfoSchema.extend({
